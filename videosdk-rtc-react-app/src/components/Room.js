      ...
      <div className="room__container">
        <section className="members__container">
          <div className="members__header">
            <p>Participants</p>
            <strong className="members__count">27</strong>
          </div>
          <div className="member__list">
            <div className="member__wrapper member__1__wrapper">
              <span className="green__icon" />
              <p className="member_name">Sulammita</p>
            </div>
            <div className="member__wrapper member__2__wrapper">
              <span className="green__icon" />
        ...
        <section className="stream__container">
